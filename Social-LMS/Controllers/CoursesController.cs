...
namespace Social_LMS.Controllers
{
    public class CoursesController : Controller
    {
        ...
        {
            ViewData["DepartmentId"] = new SelectList(_context.Department, "Id", "NameFull");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Code,Description,CreatedDate,DepartmentId")] Course course)
        {
            ...
            ViewData["DepartmentId"] = new SelectList(_context.Department, "Id", "NameFull", course.DepartmentId);
            return View(course);
        }
