...
namespace Social_LMS.Controllers
{
    public class FacultiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CreatedDate")] Faculty faculty)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CreatedDate")] Faculty faculty)
        {
            if (id != faculty.Id)
            {
                return NotFound();
